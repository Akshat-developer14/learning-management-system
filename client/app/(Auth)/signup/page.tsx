...
const Signup: React.FC<Props> = ({ setRoute }) => {
  ...
  return (
    <div className="w-full h-screen sm:p-24 md:px-44 p-10 mb-20">
      <h1 className="text-[25px] text-black dark:text-white font-[500] font-Poppins text-center py-2 rounded">Register with E-Learning</h1>
      <form onSubmit={handleSubmit}>
        ...
        <div className="w-full mt-5">
          <input type="submit" value="Signup" className={`flex flex-row justify-center items-center py-3 px-6 rounded-full cursor-pointer min-h-[45px] w-full text-[16px] font-Poppins font-semibold bg-[#2190ff]`} />
        </div>
        <br />
