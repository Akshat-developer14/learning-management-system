...
import { addAnswer, addQuestion, AddReplyToReview, AddReview, deleteCourse, editCourse, getAllCourse, getAllCourses, getCourseForValidUser, getSingleCourse, uploadCourse } from '../controllers/course.controller';
